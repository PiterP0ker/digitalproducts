...
var baSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-slider');
baSlider.slick({
  slide: '.ba-slide',
  dots: true,
  arrows: false
});
var baTeamSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-team-slider');
baTeamSlider.slick({
  slide: '.ba-team-slide',
  dots: true,
  arrows: false,
...
function initBaMap() {
  ...
  var cities = {
    indonesia: {
      ...
      address: 'Jl. Ikan Piranha Atas No.220'
    }
  };
  var mapCenter = cities.indonesia.coords; // The map, centered at mapCenter
  ...
  var $baMap = new google.maps.Map(mapEl, mapOptions);

  for (var city in cities) {
    var marker = new google.maps.Marker({
      position: cities[city].coords,
      map: $baMap,
      icon: "{{root}}assets/img/favicon.png"
    });
  } //move map center on select change


  var citySelect = document.querySelector('[data-city-select]');
  citySelect.addEventListener('change', function () {
    var city = citySelect.value;
    var newCoords = cities[city].coords;
...
module.exports = __webpack_require__(/*! g:\programming\beetroot\digitalproducts\src\assets\js\app.js */"./src/assets/js/app.js");
